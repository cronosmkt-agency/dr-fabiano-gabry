...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Dr. Fabiano Gabry — Implantes Dentários & Prótese Protocolo | Teresópolis" },
      { name: "description", content: "Implantes guiados sem dor, dentadura fixa protocolo e odontologia de alto padrão com mais de 370 avaliações 5 estrelas no Armazém do Grão/Rodoviária." },
      { property: "og:title", content: "Dr. Fabiano Gabry Soluções Odontológicas & Implantes" },
      { property: "og:description", content: "O sorriso dos seus sonhos com dentes fixos e o padrão número 1 de Teresópolis." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
    ],
    links: [
      { rel: "stylesheet", href: appCss },
      { rel: "icon", type: "image/svg+xml", href: "data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 100 100'><rect width='100' height='100' rx='25' fill='#0a192f'/><text x='50%' y='55%' text-anchor='middle' dominant-baseline='middle' fill='white' font-family='sans-serif' font-weight='800' font-size='40'>FG</text></svg>" },
